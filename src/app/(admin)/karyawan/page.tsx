...
import { useGetEmployee } from "@/components/parts/admin/karyawan/api";
import DataTable from "@/components/parts/admin/karyawan/Datatable";
...
function EmployeePage() {
  ...
  // Data fetching
  const { data } = useGetEmployee(currentPage, search, limit);
